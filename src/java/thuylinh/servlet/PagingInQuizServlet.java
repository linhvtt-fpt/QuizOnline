 ...
 * @author Thuy Linh
 */
@WebServlet(name = "PagingInQuizServlet", urlPatterns = {"/PagingInQuizServlet"})
public class PagingInQuizServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int recordOnPage = (int) session.getAttribute("RecordOnPage");
